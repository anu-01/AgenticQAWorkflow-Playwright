---
mode: agent
description: End-to-End QA Workflow with Natural Language — 7-step agentic flow from user story to committed automated tests using Playwright MCP agents and GitHub MCP.
---
...
userstories/SCRUM-101-ecommerce-checkout.md
...
**Git Repository URL:** https://github.com/anu-01/AgenticQAWorkflow-Playwright
